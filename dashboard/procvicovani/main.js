...
// Version: 25.0.10 - Added missing render...Skeletons functions.
// Doplněny chybějící funkce pro vykreslování skeletonů.
...
(function() { // Start IIFE
    ...
    // --- START: Skeleton Rendering Functions (DOPLNĚNÉ) ---
    ...
    function setLoadingState(sectionKey, isLoadingFlag) {
        ...
        const updateSingleSection = (key, loading) => {
            ...
            if (loading) {
                ...
                // Zajistíme, že skeletonFn je skutečně funkce před jejím voláním
    ...
    function configureUIForGoal() {
        ...
        if (activeTabButton) {
            ...
            isInitialTabLoad = true; // Přesunuto sem, aby bylo definováno před switchActiveTab
    ...
    async function initializeApp() {
        try {
            ...
            if (ui.mainContent) ui.mainContent.style.display = 'block';
            setLoadingState('all', false); // Zajistíme, že se setLoadingState volá i při chybě
        } finally {
