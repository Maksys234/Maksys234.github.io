(function() { // IIFE для изоляции области видимости
    ...
    const ui = {
         ...
         mobileMenuToggle: document.getElementById('mobile-menu-toggle'),        // Main toggle in header (assuming this ID exists in plan.html)
         sidebarCloseToggle: document.getElementById('sidebar-close-toggle'),   // Close button inside sidebar
    ...
    const updateCopyrightYear = () => { const year = new Date().getFullYear(); if (ui.currentYearSidebar) ui.currentYearSidebar.textContent = year; if (ui.currentYearFooter) ui.currentYearFooter.textContent = year; };
     ...
     const updateOnlineStatus = () => { /* No offline banner in plan.html */ };
    ...
    const switchTab = async (tabId) => {
        ...
        // Also explicitly hide sub-content areas
    ...
    const checkPlanCreationAvailability = async () => {
        ...
        try {
            ...
            if (canCreate) {
                ...
                console.log("[CreateCheck] Rendering 'Locked Plan' message.");
