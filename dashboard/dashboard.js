// dashboard.js
// Verze: 26.0.5 - Zrobustnění setLoadingState, oprava přístupu ke kontejneru creditHistory, ošetření 'titles'
(function() {
    'use strict';
    ...
    async function initializeApp() {
        console.log("[INIT Dashboard] initializeApp: Start v26.0.5");
        cacheDOMElements();
