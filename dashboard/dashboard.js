...
(function() {
    ...
    async function initializeApp() { /* ... (Логика без изменений, но теперь с currentProfile и Sidebar State) ... */
         console.log("[INIT Dashboard] initializeApp: Start");
         if (!initializeSupabase()) return;
         setupUIEventListeners(); // <<< Setup listeners BEFORE applying state
    ...
    function setupUIEventListeners() { /* ... (добавлены слушатели для анимаций и Sidebar Toggle) ... */
